...
def build_readiness() -> dict:
    areas = [
        ...
        {"area": "Data-provider governance", "state": "working", "detail": "Explicit catalogue separates official filings, benchmarks, macro, discovery signals and licensed-only data"},
        {"area": "Real company data", "state": "blocked", "detail": "Provider connectors, entity resolution, rights checks and credentials are not connected yet"},
